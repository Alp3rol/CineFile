...
class GraphExporter {
  ...
  static Future<ui.Image?> captureBoundary(
    GlobalKey key, {
    ...
    try {
      ...
      reportError(error, stackTrace, where: 'relationshipGraph.capture');
      return null;
    }
  }
  ...
  static Future<List<int>?> imageToPngBytes(ui.Image image) async {
    try {
      ...
      reportError(error, stackTrace, where: 'relationshipGraph.pngEncode');
      return null;
    }
  }
}
