        ...
        return Consumer(
          builder: (context, ref, _) {
            ...
            return recordsAsync.when(
              ...
              data: (records) {
                return _PremiumFeaturedSelectorDialog(
                  records: records,
...
class _PremiumFeaturedSelectorDialog extends StatefulWidget {
  final List<dynamic> records;
  final List<String> initialSelectedIds;
  final Function(List<String>) onSave;

  const _PremiumFeaturedSelectorDialog({
  ...
  @override
  State<_PremiumFeaturedSelectorDialog> createState() => _PremiumFeaturedSelectorDialogState();
}

class _PremiumFeaturedSelectorDialogState extends State<_PremiumFeaturedSelectorDialog> {
